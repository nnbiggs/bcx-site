...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0b0b0f] text-gray-400 w-full min-w-0">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-14 lg:px-8">
        <div className="grid grid-cols-1 gap-12 sm:gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div className="col-span-1 md:col-span-2 min-w-0">
            <div className="flex items-center gap-3 mb-5">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#c8102e] to-[#9f0d24] text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/program" className="text-sm text-gray-400 hover:text-white transition-colors inline-block py-1">
                  Program
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-sm text-gray-400 hover:text-white transition-colors inline-block py-1">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/coaching" className="text-sm text-gray-400 hover:text-white transition-colors inline-block py-1">
                  Coaching
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-sm text-gray-400 hover:text-white transition-colors inline-block py-1">
                  FAQ
                </Link>
              </li>
            </ul>
