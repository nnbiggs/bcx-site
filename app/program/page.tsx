...
export const metadata: Metadata = {
  title: 'Program',
  description: 'Explore BCX track and field programs: sprints, distance, jumps, throws, and multi-events for ages 6–13. Comprehensive training for every skill level.',
  openGraph: {
